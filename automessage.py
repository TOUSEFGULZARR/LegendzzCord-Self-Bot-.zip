...
class Automsg(commands.Cog):
    ...
    @commands.command(name='auto', aliases=['am'], brief="Set auto message", usage=".auto <time in sec> true <channel> <message>")
    async def auto(self, ctx, interval: int, repeat: bool, channel: discord.TextChannel, *, content):
